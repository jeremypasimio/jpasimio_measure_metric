...
import main.java.memoranda.Parameter;
...
public class EventsPanel extends JPanel {
	...
	int rtype;
        ...
        //Created Parameter p and set values.
        p.setType(rtype);
        p.setStartDate(sd);
        p.setEndDate(ed);
        p.setPeriod(period);
        ...
        p.setMm(mm);
        p.setText(text);
        p.setWorkDays(dlg.workingDaysOnlyCB.isSelected());
        EventsManager.createRepeatableEvent(p);
    }
